...
<title><?php echo $title;?> |E-Learning</title>
...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="cap.png">Universitatea din Craiova<br>Facultatea de Automatica si Calculatoare
      <br>200385 CRAIOVA
      <p class="subtitle"> Platforma experimentala de E-Learning </p> 
  </div>
</section>  
<section id="navigation">
  <div id="mySidenav" class="sidenav">
    <a href="<?php echo web_root; ?>index.php?q=lesson" id="lesson">Lectii <i class="fa fa-home pull-right"></i></a> 
    <a href="<?php echo web_root; ?>index.php?q=exercises" id="exercise">Exercitii <i class="fa fa-pencil pull-right"></i></a>
    <a href="<?php echo web_root; ?>index.php?q=download" id="download">Download <i class="fa fa-download pull-right"></i></a>
    <a href="<?php echo web_root; ?>index.php?q=about" id="about">Despre noi <i class="fa fa-info-circle pull-right"></i></a>  
...
<footer  >
    <p align="left">&copy; Universitatea din Craiova</p>
</footer>
</section>
