...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="cap.png">Universitatea din Craiova
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <div class="col-md-9">
                      ...
                      <div class="col-md-8">
                        <button type="submit" name="btnRegister" class="btn btn-primary btn-sm">Inregistrare</button>
                        <a href="login.php"><i class="fa fa-arrow-left"></i> Inapoi la Login</a>
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff;">
              <p align="left">&copy; E-Learning - Claudia </p>
     </footer>
 </section>
